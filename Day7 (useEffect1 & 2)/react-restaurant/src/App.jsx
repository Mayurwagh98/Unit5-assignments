		...
		<div className='app'>
			...
			<div className='addRes'>
				...
				<form onSubmit={createRestaurent}>
					<div>
						<label htmlFor='name' className='res_name'><b>Restaurent name: </b></label>
						<input
							type='text'
					...
					<div>
						<label htmlFor='image' className='res_name'><b>Image url:</b></label>
						<input
							type='text'
					...
					<div>
						<label htmlFor='votes' className='res_name'><b>Votes:</b></label>
						<input
							type='Number'
							placeholder='Votes'
							id='votes'
					...
					<div>
						<label htmlFor='review' className='res_name'><b>Review:</b></label>
						<input
							type='text'
							placeholder='review'
							id='review'
					...
					<div>
						<label htmlFor='cost' className='res_name'><b>Cost per Item:</b></label>
						<input
							type='Number'
					...
					<div>
						<label htmlFor='categories' className='res_name'><b>Categories(comma values):</b></label>
						<input
							type='text'
					...
					<div>
						...
						<label htmlFor='card'><i>CARD</i></label>
						<input
							type='checkbox'
							id='card'
						...
						<label htmlFor='cash'><i>CASH</i></label>
						<input
							type='checkbox'
							id='cash'
						...
						<label htmlFor='upi'><i>UPI</i></label>
						<input
							type='checkbox'
							id='upi'
			...
			<div className='sort'>
				<h2 className='sort_heading'>Sort restaurents by rating</h2>
